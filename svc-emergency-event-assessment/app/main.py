...
# 服务基础配置
# =========================
SERVICE_NAME = os.getenv("SERVICE_NAME", "svc-emergency-event-assessment")
...
# 负载参数
WORKLOAD_REPEAT = int(os.getenv("WORKLOAD_REPEAT", "18"))
INNER_ITERS = int(os.getenv("INNER_ITERS", "260000"))
